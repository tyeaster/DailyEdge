...
| Historical Market Storage | Canonical market snapshot/result ledger, Drizzle migration, live/replay/mock provider, Daily Slate game-market recording, and Calibration/Backtesting/Odds Intelligence/Ranking read integration | Automated settlement and complete per-market recording still need to be wired from each dedicated market service; Run Line and Game Total Daily Slate records are odds-only until market model values are attached |
