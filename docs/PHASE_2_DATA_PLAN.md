...
| Confirmed lineups | MLB schedule hydration, live game feed, and boxscore batting order | Official endpoint | SportsDataIO or Sportradar | MLB game page is possible but unnecessary | Record schedule/feed payloads | 1 minute near first pitch; 5 minutes otherwise | Mark lineup unconfirmed; no lineup adjustment |
...
1. Live bullpen quality.
2. Confirmed starting lineups.
3. Stadium-level weather and roof state.
